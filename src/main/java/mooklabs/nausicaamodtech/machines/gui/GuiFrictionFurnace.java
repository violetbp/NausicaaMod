...
public class GuiFrictionFurnace extends GuiContainer {
	public static final ResourceLocation texture = new ResourceLocation(TechMain.modid, "textures/gui/grinder.png");
	
	public TileEntityFrictionFurnace grinder;
	
	public GuiFrictionFurnace(InventoryPlayer invPlayer, TileEntityFrictionFurnace entity) {
		super(new ContainerFrictionFurnace(invPlayer, entity));
	...
	public void drawGuiContainerBackgroundLayer(float f, int j, int i) {
		...
		if(this.grinder.hasPower()){
			i1 = this.grinder.getBurnTimeRemainingScaled(100);
