...
import cpw.mods.fml.relauncher.SideOnly;
	...
	public class TileEntityFrictionFurnace extends TileEntityMachineBase implements ISidedInventory{
	    ...
	    /**
	     * How hot the furnace is. Think induction furnace.
	     */
	    public int furnaceHeat=0;
	    private String field_145958_o;
	    private static final String __OBFID = "CL_00000357";
		private static final int timeToSmelt = 30;
		...
		public void readFromNBT(NBTTagCompound p_145839_1_)
	    {
	        ...
	        this.furnaceCookTime = p_145839_1_.getShort("Heat");
		...
		public void writeToNBT(NBTTagCompound tagCompound)
	    {
	        ...
	        {
	            tagCompound.setString("CustomName", this.field_145958_o);
	        }
	    }
		...
		public void updateEntity()
	    {
	    	...
	    	if(this.currentPower > 0)
	    		this.furnaceBurnTime = currentPower;
	        ...
	        if (!this.worldObj.isRemote)
	        {
	            ...
	            if (this.isBurning() && this.canSmelt())
	            {
	                ...
	                if(this.furnaceItemStacks[0].getItem() instanceof ItemFood)
		            this.furnaceCookTime+=3;

	                int mod = this.currentPower;
	               
	            
	                if (this.furnaceCookTime < this.timeToSmelt-mod)
	                {
