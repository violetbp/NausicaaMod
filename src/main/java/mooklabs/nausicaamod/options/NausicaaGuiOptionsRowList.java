package mooklabs.nausicaamod.options;

import java.util.List;

import mooklabs.nausicaamod.Main;
import mooklabs.nausicaamod.NausicaaGameSettings;
...
public class NausicaaGuiOptionsRowList extends GuiOptionsRowList {

	private final List field_148184_k = Lists.newArrayList();
	private static final String __OBFID = "CL_00000677";

	public NausicaaGuiOptionsRowList(Minecraft p_i45015_1_, int p_i45015_2_, int p_i45015_3_, int p_i45015_4_, int p_i45015_5_, int p_i45015_6_, NausicaaGameSettings.Options... p_i45015_7_) {
		...
		for (int j1 = 0; j1 < p_i45015_7_.length; j1 += 2) {
			NausicaaGameSettings.Options options = p_i45015_7_[j1];
			NausicaaGameSettings.Options options1 = j1 < p_i45015_7_.length - 1 ? p_i45015_7_[j1 + 1] : null;
	...
	private GuiButton func_148182_a(Minecraft p_148182_1_, int p_148182_2_, int p_148182_3_, NausicaaGameSettings.Options p_148182_4_) {
		if (p_148182_4_ == null) {
			return null;
		} else {
			final Main main = Main.instance;
			int k = p_148182_4_.returnEnumOrdinal();
			//return (GuiButton) (p_148182_4_.getEnumFloat() ? new GuiOptionSlider(k, p_148182_2_, p_148182_3_, p_148182_4_) : new GuiOptionButton(k, p_148182_2_, p_148182_3_, p_148182_4_,
			//		main.gameSettings.getKeyBinding(p_148182_4_)));
		}
		return null;
	}
