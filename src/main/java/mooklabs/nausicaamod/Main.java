...
import mooklabs.nausicaamod.blocks.*;
import mooklabs.nausicaamod.glider.*;
...
import mooklabs.nausicaamod.mobs.*;
import mooklabs.nausicaamod.proxy.CommonProxy;
import mooklabs.nausicaamod.proxy.GuiHandlerNausicaa;
import mooklabs.nausicaamod.tools.*;
import mooklabs.nausicaamodtech.TechMain;//This import should not be here
...
public class Main extends MMod{
	...
	public static final String VERSION = "0.0.08";
